  ...
  return {
    ...
    tasks: {
      post: (option: { body: Methods_w6o6q4['post']['reqBody'], config?: T | undefined }) =>
        fetch<Methods_w6o6q4['post']['resBody']>(prefix, PATH5, POST, option).json(),
      $post: (option: { body: Methods_w6o6q4['post']['reqBody'], config?: T | undefined }) =>
        fetch<Methods_w6o6q4['post']['resBody']>(prefix, PATH5, POST, option).json().then(r => r.body),
      get: (option: { query: Methods_w6o6q4['get']['query'], config?: T | undefined }) =>
        fetch<Methods_w6o6q4['get']['resBody']>(prefix, PATH5, GET, option).json(),
      $get: (option: { query: Methods_w6o6q4['get']['query'], config?: T | undefined }) =>
        fetch<Methods_w6o6q4['get']['resBody']>(prefix, PATH5, GET, option).json().then(r => r.body),
