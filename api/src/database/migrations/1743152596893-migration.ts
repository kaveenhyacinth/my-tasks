...
export class Migration1743152596893 implements MigrationInterface {
    name = 'Migration1743152596893'
    ...
    public async up(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`CREATE TABLE "roles" ("id" UUID DEFAULT gen_random_uuid() NOT NULL, "createdAt" timestamptz NOT NULL DEFAULT now(), "updatedAt" timestamptz NOT NULL DEFAULT now(), "roleName" varchar NOT NULL, CONSTRAINT "PK_c1433d71a4838793a49dcad46ab" PRIMARY KEY ("id"))`);
        await queryRunner.query(`CREATE TABLE "tasks" ("id" UUID DEFAULT gen_random_uuid() NOT NULL, "createdAt" timestamptz NOT NULL DEFAULT now(), "updatedAt" timestamptz NOT NULL DEFAULT now(), "name" varchar NOT NULL, "description" string NOT NULL, "priority" int8 NOT NULL, "dueDate" timestamptz NOT NULL, "assigneeId" uuid, CONSTRAINT "PK_8d12ff38fcc62aaba2cab748772" PRIMARY KEY ("id"))`);
        await queryRunner.query(`CREATE INDEX "IDX_9a16d2c86252529f622fa53f1e" ON "tasks" ("assigneeId") `);
        await queryRunner.query(`CREATE TABLE "users" ("id" UUID DEFAULT gen_random_uuid() NOT NULL, "createdAt" timestamptz NOT NULL DEFAULT now(), "updatedAt" timestamptz NOT NULL DEFAULT now(), "firstName" varchar NOT NULL, "lastName" varchar NOT NULL, "username" varchar NOT NULL, "password" varchar NOT NULL, "departmentId" uuid, "roleId" uuid, CONSTRAINT "UQ_fe0bb3f6520ee0469504521e710" UNIQUE ("username"), CONSTRAINT "PK_a3ffb1c0c8416b9fc6f907b7433" PRIMARY KEY ("id"))`);
